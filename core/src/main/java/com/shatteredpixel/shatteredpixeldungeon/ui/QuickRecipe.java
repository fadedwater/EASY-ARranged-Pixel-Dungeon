	...
	public static ArrayList<QuickRecipe> getRecipes( int pageIdx ){
		...
		switch (pageIdx){
			...
			case 6:
				...
				result.add(null);
				result.add(null);
				result.add(new QuickRecipe(new WornShortsword_Energy.Recipe()));
				result.add(new QuickRecipe(new Gloves_Energy.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new Dagger_Energy.Recipe()));
				result.add(new QuickRecipe(new Saber_Energy.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new WornKatana_Energy.Recipe()));
				result.add(new QuickRecipe(new CrudePistol_Energy.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new Rapier_Energy.Recipe()));
				result.add(null);
				result.add(null);
				...
				result.add(null);
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Empty_Sword.Recipe()));
				result.add(null);
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Fire_Sword.Recipe()));
				result.add(new QuickRecipe(new SpellBook_Frost_Sword.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Lightning_Sword.Recipe()));
				result.add(new QuickRecipe(new SpellBook_Disintegration_Sword.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Blast_Sword.Recipe()));
				result.add(new QuickRecipe(new SpellBook_Corrosion_Sword.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Prismatic_Sword.Recipe()));
				result.add(new QuickRecipe(new SpellBook_Regrowth_Sword.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Transfusion_Sword.Recipe()));
				result.add(new QuickRecipe(new SpellBook_Corruption_Sword.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SpellBook_Warding_Sword.Recipe()));
				result.add(new QuickRecipe(new SpellBook_Earth_Sword.Recipe()));
				result.add(null);
				result.add(null);
			...
			case 9:
				...
				result.add(new QuickRecipe(new Lighter.Recipe()));
				result.add(new QuickRecipe(new Cooler.Recipe()));
				return result;
		}
	}
